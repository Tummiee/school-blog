  ...
  return (
    <div className='reviewsContainer'>
        <div className='homeCont1'>
            ...
            {blogs.slice(0, 1).map(({id,description,name,mediaUrl}) => {
                            return(
                                <FeaturedReviewsItem
                                    key={id}
                                    name={name}
        ...
        <div className='reviewCont2'>
                <div className='blogCards'>
                    {paginatedBlogs.slice(1).map(({id,description,name,mediaUrl}) => {
                        return(
                            <BlogItems
                                key={id}
                                name={name}
                ...
                <div className="pagination-buttons" style={{ display: 'flex', justifyContent: 'center', gap: '1rem', marginTop: '40px' }}>
                                    ...
                                    <button onClick={nextPage} disabled={startIndex + itemsPerPage >= blogs.length}style={{borderTopRightRadius: '10px',
